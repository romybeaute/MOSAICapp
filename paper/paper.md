...
MOSAICapp is built with Streamlit, chosen for its ability to create interactive web applications from Python scripts while maintaining compatibility with scientific computing libraries. The architecture reflects several design decisions driven by the needs of phenomenological research:
...
![Secondary view of the MOSAICapp user interface detailing extended functional parameters.](MOSAICapp_interface2.png)
